 ...
 */
    ...
    !defined(RE3_INPUT_EVDEV) && !defined(RE3_INPUT_SDL) && !defined(RE3_OUTPUT_SPI)

#include "input_source.h"
#include <stdio.h>

static void null_init(void) { printf("input: none (no input backend configured)\n"); }
static void null_poll(void) {}
static void null_terminate(void) {}
